...
namespace AgenteMarketingTeste.Controllers
{
    public class ProdutoesController : Controller
    {
        ...
        public ProdutoesController(AgenteMarketingTesteContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Produto.FromSql("spListarProdutos").OrderBy(x => x.NomeProduto).ToListAsync());
        }
